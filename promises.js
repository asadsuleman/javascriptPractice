...
const fetching = fetch("https://jsonplaceholder.typicode.com/users")
    .then((responseData) => responseData.json()) // responseData is the data we fetched form server and converted into .json 
    .then((jsonData) => console.log(jsonData)) //consiling the json formate data 
    .catch((errorData) => console.log(errorData)); //catching error if there is any.